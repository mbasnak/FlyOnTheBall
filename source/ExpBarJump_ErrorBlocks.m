function [daq_data] = ExpBarJump_ErrorBlocks(flyNum,expNum)
...
niOI.DurationInSeconds = 5280 + 20; %set the duration to the total panel display time + 20 extra seconds
...
Panel_com('start');
pause(5280+4) %record for the time it takes to span the number of trials requested
Panel_com('stop');
...
save(strcat('dataExpNum',num2str(expNum),'.mat'),'daq_data'); %save daq data and starting positions as a .mat file
