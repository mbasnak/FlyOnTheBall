...
%  reset time points. Then the position signal is LOW PASS FILTERED two times!! to
...
%How do you know what a realistic fly velocity is?

%
%   OUTPUT
%   velocityOut -array containing ball's instantanous velocity (degree/sec)
%   accumulatedPositionOut - array containing the filtered and unwraped
%   position signal
%
%   Yvette Fisher 1/2018
% ------------------------------
FICTRAC_MAX_VOLTAGE = 10;  % The Ni-Daq reads a signal from 0 to 10V coming from FicTrac to code the positions
...
% of ±2pi when absolute jumps between consecutive elements of P are greater than or equal to the default jump tolerance of pi radians.


% % Plot the wrapped and unwrapped together to see the effect
% figure,
% subplot(2,1,1)
% plot(posRadians)
% subplot(2,1,2)
