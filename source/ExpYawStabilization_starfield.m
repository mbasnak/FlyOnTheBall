function [daq_data] = ExpYawStabilization_starfield(flyNum,expNum,TrialNum)

% This function runs an experiment in which a starfield is presented in closed-loop and
% every 200 s, the loop opens for 1 sec and the starfield rotates in one of
% the other direction

%I'm using a y function to make the
%grating move
...
%%%%%% Run the panels %%%%%%
Panel_com('set_pattern_id', 14); %set the starfield
