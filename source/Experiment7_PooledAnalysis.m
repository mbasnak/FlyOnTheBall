...
AFirstMasterBlock = dir('Z:\Wilson Lab\Mel\FlyOnTheBall\data\Experiment7\*\*\ActivityHighErrorBlockExp3.mat');
AYokedBlock = dir('Z:\Wilson Lab\Mel\FlyOnTheBall\data\Experiment7\*\*\ActivityYoked*.mat');
ASecondMasterBlock = dir('Z:\Wilson Lab\Mel\FlyOnTheBall\data\Experiment7\*\*\ActivityHighErrorBlockExp5.mat');
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\FlyOnTheBall\data\Experiment7\ActivityAcrossBlocks.png'))
saveas(gcf,strcat('Z:\Wilson Lab\Mel\FlyOnTheBall\data\Experiment7\ActivityAcrossBlocks.svg'))
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\FlyOnTheBall\data\Experiment7\StateTransitions.png'))
saveas(gcf,strcat('Z:\Wilson Lab\Mel\FlyOnTheBall\data\Experiment7\StateTransitions.svg'))

%% Around jump velocities

FirstLowErrorBlock = dir('Z:\Wilson Lab\Mel\FlyOnTheBall\data\Experiment7\*\*\perTrialDataHighErrorBlockExp3.mat');
HighErrorBlock = dir('Z:\Wilson Lab\Mel\FlyOnTheBall\data\Experiment7\*\*\perTrialDataYoked*.mat');
SecondLowErrorBlock = dir('Z:\Wilson Lab\Mel\FlyOnTheBall\data\Experiment7\*\*\perTrialDataHighErrorBlockExp5.mat');
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\FlyOnTheBall\data\Experiment7\AverageVelocityChange.png'))
saveas(gcf,strcat('Z:\Wilson Lab\Mel\FlyOnTheBall\data\Experiment7\AverageVelocityChange.svg'))
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\FlyOnTheBall\data\Experiment7\AverageVelocityProgressionHE.png'))
saveas(gcf,strcat('Z:\Wilson Lab\Mel\FlyOnTheBall\data\Experiment7\AverageVelocityProgressionHE.svg'))
...
FilesFirstLE = dir('Z:\Wilson Lab\Mel\FlyOnTheBall\data\Experiment7\*\*\goalsHighErrorBlockExp3.mat');
FilesHE = dir('Z:\Wilson Lab\Mel\FlyOnTheBall\data\Experiment7\*\*\goalsYoked*.mat');
FilesSecondLE = dir('Z:\Wilson Lab\Mel\FlyOnTheBall\data\Experiment7\*\*\goalsHighErrorBlockExp5.mat');
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\FlyOnTheBall\data\Experiment7\GoalDist.png'))
saveas(gcf,strcat('Z:\Wilson Lab\Mel\FlyOnTheBall\data\Experiment7\GoalDist.svg'))
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\FlyOnTheBall\data\Experiment7\GoalDistAcrossBlocks.png'))
saveas(gcf,strcat('Z:\Wilson Lab\Mel\FlyOnTheBall\data\Experiment7\GoalDistAcrossBlocks.svg'))
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\FlyOnTheBall\data\Experiment7\Dist2GoalAllTrials.png'))
saveas(gcf,strcat('Z:\Wilson Lab\Mel\FlyOnTheBall\data\Experiment7\Dist2GoalAllTrials.svg'))
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\FlyOnTheBall\data\Experiment7\Dist2goal.png'))
saveas(gcf,strcat('Z:\Wilson Lab\Mel\FlyOnTheBall\data\Experiment7\Dist2goal.svg'))


%% Distance to the goal in the 10 sec around the jumps

FilesLE = dir('Z:\Wilson Lab\Mel\FlyOnTheBall\data\Experiment7\*\*\shortData10secHighErrorBlockExp3.mat');
FilesHE = dir('Z:\Wilson Lab\Mel\FlyOnTheBall\data\Experiment7\*\*\shortData10secYoked*.mat');
FilesSecondLE = dir('Z:\Wilson Lab\Mel\FlyOnTheBall\data\Experiment7\*\*\shortData10secHighErrorBlockExp5.mat');
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\FlyOnTheBall\data\Experiment7\Dist2Goal10secHeatMap.png'))
saveas(gcf,strcat('Z:\Wilson Lab\Mel\FlyOnTheBall\data\Experiment7\Dist2Goal10secHeatMap.svg'))
